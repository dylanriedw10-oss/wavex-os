...
const TIERS: Tier[] = [
  {
    ...
    name: "Founder",
    priceMonthly: 29,
    cadence: "1 daily board-level directive",
  ...
  },
  {
    ...
    tokenCap: "Unlimited (100 directives/day cap)",
    features: [
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <header style={{ marginBottom: 32, textAlign: "center" }}>
          ...
          <p style={{ color: "#8a8a92", fontSize: 16, lineHeight: 1.5, maxWidth: 720, margin: "16px auto 0" }}>
            ...
            The optional optimizer subscription adds daily board-level directives, error recovery, and
