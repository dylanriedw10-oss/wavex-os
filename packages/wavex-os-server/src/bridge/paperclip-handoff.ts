...
/** Project the wavex-os slot taxonomy onto Paperclip's role enum.
...
function resolveRepoRoot(): string {
  // src lives at: packages/wavex-os-server/src/bridge/paperclip-handoff.ts
...
async function hireOne(
  ...
  const payload: Record<string, unknown> = {
    ...
    capabilities: `Vendored from wavex-os wavex-os manifest. Original slot=${slot}, template=${entry.template_id ?? orig}.`,
